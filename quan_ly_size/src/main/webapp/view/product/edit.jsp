...
<div class="row m-4 ">
    ...
    <div class="col-md-6 " style="float: right">
        ...
        <form action="/quan_ly_size?action=edit" method="post" class="b1">

            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" style="font-weight: bold">Mã loại size</label>
                <div class="col-sm-8">
                    <input type="text" name="sizeId" value="${quanLySize.getSizeId()}" readonly>
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" style="font-weight: bold">Tên loại size</label>
                <div class="col-sm-8">
                    <input type="text" name="nameSize" id="name" value="${quanLySize.getNameSize()}">
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" style="font-weight: bold">Mô tả</label>
                <div class="col-sm-8">
                    <input type="text" name="describe" id="describe" value="${quanLySize.getDescribe()}">
                </div>
            </div>
            ...
            <button type="button"><a href="/quan_ly_size">BACK</a></button>
        </form>
    </div>
</div>
</body>
